...
class AlarmRingScreen extends StatefulWidget {
  ...
  const AlarmRingScreen({super.key, required this.medicine});
...
class _AlarmRingScreenState extends State<AlarmRingScreen>
  ...
  void initState() {
    ...
    // Play alarm sound
    AlarmService().playSound(widget.medicine.alarmSound);
  }
  ...
  void _snooze() async {
    ...
    await AlarmService().scheduleAlarm(
      id: widget.medicine.key.hashCode + 999,
      medicineName: widget.medicine.name,
      dose: widget.medicine.dose,
      dateTime: snoozeTime,
      assetAudioPath: widget.medicine.alarmSound,
      vibrate: widget.medicine.vibrateEnabled,
    );
  ...
  void _sendSMS() {
    ...
    if (contacts.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
              'No emergency contacts found. Add contacts in the Emergency screen.'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Scheduled at ${widget.medicine.time}',
