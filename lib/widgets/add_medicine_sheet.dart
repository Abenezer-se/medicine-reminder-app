...
class _AddMedicineSheetState extends State<AddMedicineSheet> {
  ...
  void _save() {
    ...
    final doseAmt = doseAmountController.text.trim();
    ...
    if (_times.isEmpty) {
      _snack('Please add at least one alarm time');
      return;
    }

    final dose = '$doseAmt $_doseUnit';
    final time = _fmtTime(_times.first);
    ...
    _snack('✅ $name saved — alarm set for $time', success: true);
  }
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration:
                        inputDec('Medicine Name *', icon: Icons.medication),
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          style: TextStyle(color: text),
                          decoration:
                              inputDec('Start Date', icon: Icons.calendar_today)
                                  .copyWith(
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          style: TextStyle(color: text),
                          decoration:
                              inputDec('End Date', icon: Icons.event).copyWith(
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.edit_calendar,
                                  color: primary),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const Text('Save & Set Alarm',
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Colors.white)),
